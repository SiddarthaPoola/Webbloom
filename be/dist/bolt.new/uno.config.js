...
const iconPaths = (0, fast_glob_1.globSync)('./icons/*.svg');
const collectionName = 'bolt';
const customIconCollection = iconPaths.reduce((acc, iconPath) => {
    var _a;
    const [iconName] = (0, node_path_1.basename)(iconPath).split('.');
    (_a = acc[collectionName]) !== null && _a !== void 0 ? _a : (acc[collectionName] = {});
    acc[collectionName][iconName] = () => __awaiter(void 0, void 0, void 0, function* () { return promises_1.default.readFile(iconPath, 'utf8'); });
    return acc;
}, {});
const BASE_COLORS = {
    white: '#FFFFFF',
...
const COLOR_PRIMITIVES = Object.assign(Object.assign({}, BASE_COLORS), { alpha: {
...
exports.default = (0, unocss_1.defineConfig)({
    ...
    theme: {
        colors: Object.assign(Object.assign({}, COLOR_PRIMITIVES), { bolt: {
                elements: {
    ...
    transformers: [(0, unocss_1.transformerDirectives)()],
    presets: [
        ...
        (0, unocss_1.presetIcons)({
            warn: true,
            collections: Object.assign({}, customIconCollection),
        }),
    ],
});
/**
